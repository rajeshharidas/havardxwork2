...
```{r,echo=FALSE,out.width="100%", fig.cap ="random forest classification errors" , warning=FALSE, regfloat=FALSE}
library(ggplot2)  # For plotting
library(png) 
...
```{r,echo=FALSE,out.width="100%", fig.cap ="tuned random forest classification errors" , warning=FALSE, regfloat=FALSE}
library(ggplot2)  # For plotting
library(png) 
