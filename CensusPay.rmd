...
```{r,echo=FALSE,out.width="30%", fig.cap ="Comparison plots for numerical variables" , warning=FALSE, regfloat=FALSE}
library(ggplot2)  # For plotting
library(png) 
...
```{r,echo=FALSE,out.width="50%", fig.cap ="Comparison plots for categorical variables" , warning=FALSE, regfloat=FALSE}
library(ggplot2)  # For plotting
library(png) 
...
```{r,echo=FALSE, fig.retina = 2, fig.cap ="rpart decision tree" , warning=FALSE, regfloat=FALSE}
library(ggplot2)  # For plotting
library(png) 
