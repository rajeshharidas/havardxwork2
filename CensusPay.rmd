...
As this is an imbalanced dataset, we will also experiment with some sampling up with 10 fold cross validation in some of the models.
...
Further improvements could be made by using additional random oversampling and/or under-sampling techniques like SMOTE or ROSE to upscale the imbalanced datasets.
