...
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,out.width="70%" fig.cap ="Education distribution"}
library(ggplot2)  # For plotting
library(png) 
...
```
```{r,echo=FALSE,out.width="70%" fig.cap ="Occupation distribution"}
library(ggplot2)  # For plotting
library(png) 
...
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,out.width="70%" fig.cap ="Marital Status distribution"}
library(ggplot2)  # For plotting
library(png) 
