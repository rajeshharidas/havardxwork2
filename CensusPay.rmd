...
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Education"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/edufreqbar.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Education tabular"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/edufreqtab.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Race"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/racebarch.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Race tabular"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/racetab.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Marital Status"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/maritalstatusbar.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Marital Status tabular"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/maritalstatustab.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Relationship"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/relationshipbar.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Relationship tabular"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/relationshipbar.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Sex"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/sexbarch.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Sex tabular"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/sextabr.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Occupation"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/occupationbar.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Occupation tabular"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/occupationtab.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Class"}
library(ggplot2)  # For plotting
library(png) 
img_path <- "images/classbar.png"
knitr::include_graphics(img_path)
```
```{r,echo=FALSE,fig.retina = 2, fig.cap ="Class tabular"}
library(ggplot2)  # For plotting
library(png) 
