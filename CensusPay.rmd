...
Logistics model assures that the estimate \(\mathit{Pr (Y = 1 \mid X = x)}\) is between 0 and 1. Glm converts probability into log odds - \(\log\left[ \frac { P( \operatorname{y} = \operatorname{1} ) }{ 1 - P( \operatorname{y} = \operatorname{1} ) } \right]\).
