...
The accuracy of the predictions is backed by sensitivity of 0.9163 and specificity of 0.540. The F1 score 0.8869 vouches for the sensitivity and specificity. AUC is around 0.728 and is considered as acceptable considering some degree of imbalance in the dataset. 
...
Additionally, we could also use advanced algorithms like Gradient Boost Trees, support Vector Machines, and Deep Learning to improve the predicted outcomes.
